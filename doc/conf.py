...
latex_documents = [
    (master_doc, 'Podluck.tex', 'Podluck Documentation',
...
texinfo_documents = [
    (master_doc, 'Podluck', 'Podluck Documentation',
     author, 'Podluck', 'One line description of project.',
     'Miscellaneous'),
]
